...
namespace DataArt.Atlas.Core.Shell
{
    public abstract class Startup
    {
        ...
        public virtual IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc(options =>
                    {
                        ...
                        if (ApplicationSettings.Hosting.AuthenticationRequired)
                        {
                            ...
                            services
                                ...
                                {
                                    opt.AddPolicy(
                                        "policy", builder => { builder.RequireScope(ApplicationSettings.Hosting.ScopeName); });
                                })
            ...
            services.RegisterModule<WebCommunication.Container.ClientModule>();
        ...
        public virtual void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory, IApplicationLifetime appLifetime)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.Filter()
                      ...
                      .MaxTop(EnableQueryWithInlineCountAttribute.TopParamMaxValue)
                      .Count();
