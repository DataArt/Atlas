...
namespace DataArt.Atlas.Core.Idempotency
{
    public static class MessagingContext
    {
        ...
        {
            get => MessageIdStorage.Value;

            set => MessageIdStorage.Value = value;
        }

        public static bool? ProviderIdempotency
        {
            get => ProvideIdempotencyMarkerStorage.Value;

            set => ProvideIdempotencyMarkerStorage.Value = value;
        }

        public static bool IsConsumed
        {
            get => IsConsumedMarkerStorage.Value;

            set => IsConsumedMarkerStorage.Value = value;
        }
    }
}
